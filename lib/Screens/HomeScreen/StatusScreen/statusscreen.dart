      ...
      children: [
        ...
        Row(
          children: [
            ...
            UiHelper.CustomText(text: "Status", height: 20, fontweight: FontWeight.normal),
          ],
        ),
        SizedBox(
          height: 10,
        ...
        ListTile(
          ...
          title: UiHelper.CustomText(text: "My Status", height: 20, fontweight: FontWeight.normal),
          subtitle: UiHelper.CustomText(text: "Tap to add status update", height: 15, fontweight: FontWeight.normal),
        ),
        SizedBox(height: 20,),
        Padding(
          ...
          child: Row(
            ...
            UiHelper.CustomText(text: "Recent updates", height: 15, fontweight: FontWeight.normal),
        ...
        Expanded(
          child: ListView.builder(itemBuilder: (context,index){
            return ListTile(
              ...
              subtitle: UiHelper.CustomText(text: statusContent[index]["statustime"].toString(), height: 14, fontweight: FontWeight.normal),
            );
